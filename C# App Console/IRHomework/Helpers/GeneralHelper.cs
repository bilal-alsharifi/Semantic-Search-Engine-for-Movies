...
namespace IRHomework
{
    class GeneralHelper
    {
        ...
        public static List<String> getDomainNames(String eXDomainsPath)
        {
            List<String> result = new List<String>();
            var domainFilesPathes = Directory.GetFiles(eXDomainsPath, "*", SearchOption.AllDirectories);
            foreach (String domainFilePath in domainFilesPathes)
            {
                String domainName = Path.GetFileNameWithoutExtension(domainFilePath);
