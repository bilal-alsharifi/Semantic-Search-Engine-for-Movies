...
namespace MovieTrack
{
    class LanguageDetector
    {
        ...
        // each language with its abbreviation
        ...
        // cache for storing each type with the number of matching for ordered text
        ...
        private Hashtable FindTypeMatch(string text)
        {
            // find the number of matches for each type
        ...
        {
            // return language for its abbreviation
        ...
        {
            // 1. create ordered model == each term in our text with its frequency
            // 2. ckech if lang in langstat
            // 3. if yes calculate the distance between sample model and known model
        ...
        private string Identify(string text)
        {
            ...
            Hashtable scripts = FindTypeMatch(text);
